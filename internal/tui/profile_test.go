...
func (ps profileModelStub) GetAllProfiles() ([]data.Profile, error) {
	return ps.getAll()
}

func (ps profileModelStub) AddProfile(name string) (data.Profile, error) {
	return ps.add(name)
}

func (ps profileModelStub) UpdateProfile(profile data.Profile, newName string) (data.Profile, error) {
	return ps.update(profile, newName)
}

func (ps profileModelStub) DeleteProfile(profile data.Profile) error {
